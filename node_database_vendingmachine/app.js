...
//36778
//-------------------FUNCTIONS----------------------------------------------------------------
let seedDrinks = (data, table, category) => {
    data.forEach(item => {
        let drink = {
...
app.get('/seed/non-alcoholic-beers', (req, res) => {
    let content;
    if (fs_1.default.existsSync('./non-alcoholic-beers.json')) {
        fs_1.default.readFile('./non-alcoholic-beers.json', 'utf8', (err, cont) => {
        ...
        axios_1.default.get('https://api.bol.com/catalog/v4/lists/?ids=4268792077&limit=40&apikey=A1588DB3C75F426196E5C3A7A64887A9&MediaEntry=true&includeAttributes=true&format=json')
            .then((response) => {
            content = response.data.products;
            res.send(content);
            seedDrinks(content, 'non_alcoholic_beers', 'non alcoholic beer');
            fs_1.default.writeFile('non-alcoholic-beers.json', JSON.stringify(content, null, 2), (err) => {
...
app.get('/seed/beers', (req, res) => {
    let content;
    if (fs_1.default.existsSync('./beers.json')) {
        fs_1.default.readFile('./beers.json', 'utf8', (err, cont) => {
            console.log('file is read');
            content = JSON.parse(cont);
            res.send(content);
        ...
        axios_1.default.get('https://api.bol.com/catalog/v4/lists/?ids=36771&limit=40&apikey=A1588DB3C75F426196E5C3A7A64887A9&MediaEntry=true&includeAttributes=true&format=json')
            .then((response) => {
            content = response.data.products;
            res.send(content);
            seedDrinks(content, 'beers', 'beer');
            fs_1.default.writeFile('beers.json', JSON.stringify(content, null, 2), (err) => {
                console.log('file is written');
            });
        });
    }
...
app.get('/seed/red-wines', (req, res) => {
    let content;
    if (fs_1.default.existsSync('./red-wine.json')) {
        fs_1.default.readFile('./red-wine.json', 'utf8', (err, cont) => {
            console.log('file is read');
            content = JSON.parse(cont);
            res.send(content);
        ...
        axios_1.default.get('https://api.bol.com/catalog/v4/lists/?ids=4268805223&limit=40&apikey=A1588DB3C75F426196E5C3A7A64887A9&MediaEntry=true&includeAttributes=true&format=json')
            .then((response) => {
            content = response.data.products;
            console.log(content);
            ...
            res.send(content);
            seedDrinks(content, 'red_wines', 'wine');
            fs_1.default.writeFile('red-wine.json', JSON.stringify(content, null, 2), (err) => {
                console.log('file is written');
            });
        });
    }
...
app.get('/seed/liquor', (req, res) => {
    let content;
    if (fs_1.default.existsSync('./liquor.json')) {
        fs_1.default.readFile('./liquor.json', 'utf8', (err, cont) => {
            console.log('file is read');
            content = JSON.parse(cont);
            res.send(content);
        ...
        axios_1.default.get('https://api.bol.com/catalog/v4/lists/?ids=36778&limit=40&apikey=A1588DB3C75F426196E5C3A7A64887A9&MediaEntry=true&includeAttributes=true&format=json')
            .then((response) => {
            content = response.data.products;
            console.log(content);
            //console.log(response);
            res.send(content);
            seedDrinks(content, 'liquor', 'liquor');
            fs_1.default.writeFile('liquor.json', JSON.stringify(content, null, 2), (err) => {
                console.log('file is written');
            });
        });
    }
